...
| Step | Action                                                                                                                                                                                                             |
| ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `1`  | Your server calls `/integration/link` to get a `linkToken`. The `linkToken` is a temporary token used by the client to allow users to connect an account on the frontend.                                          |
...
| `3`  | Call `/integration/exchange` with the `publicToken` and exchange it for a permanent `accessToken`.                                                                                                                 |
