...
1. List off all connections for your development API key by making an API call to [connections/list](pages/home/api-reference/get-all-connections) using your development API key.
2. Find the `id` of the connection you want to delete.
3. Call [connections/delete](https://docs.vessel.dev/pages/home/api-reference/delete-one-connection) with that `id`.
