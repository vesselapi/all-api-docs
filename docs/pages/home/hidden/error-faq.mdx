...
1. List off all connections for your development API key by making an API call to **GET https://api.vessel.land/connection/connections** using your development API key.
2. Find the `connectionId` of the connection you want to delete.
3. Call **DELETE https://api.vessel.land/connection/connection** with that `connectionId`.
