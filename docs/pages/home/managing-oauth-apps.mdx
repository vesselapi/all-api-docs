...
<Warning>
  This feature is available for customers on our **Custom** plans.
</Warning>
...
OAuth apps are required for integrations that support OAuth authentication and often require some amount of configuration and management. For example, most integration providers will require your OAuth application go through an approval process before allowing customers to connect to your OAuth application.
...
<Warning>
  ...
  Callback URL to `https://app.vessel.dev/api/auth/oauth-callback`.
</Warning>
