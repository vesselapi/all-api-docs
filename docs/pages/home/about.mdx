...
Vessel is a powerful embedded native integrations platform that allows you to build and deploy native Sales and Marketing integrations in minutes. At its core, the Vessel platform is a set of modules (actions, unification, and ETL) built on top of a rich [open soruce integrations library](https://github.com/vesselapi/integrations).
